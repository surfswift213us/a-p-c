...
# Generated by qmake (2.01a) (Qt 4.8.6) on: Wed Oct 3 15:45:11 2018
...
LIBS          = $(SUBLIBS)  -L/usr/lib/x86_64-linux-gnu -lminiupnpc /root/a-p-c/src/leveldb/libleveldb.a /root/a-p-c/src/leveldb/libmemenv.a -lrt -lssl -lcrypto -ldb_cxx -lboost_system -lboost_filesystem -lboost_program_options -lboost_thread -lpthread -lQtGui -lQtNetwork -lQtCore 
AR            = ar cqs
RANLIB        = 
...
clean:compiler_clean 
	-$(DEL_FILE) $(OBJECTS)
	-$(DEL_FILE) /root/a-p-c/src/leveldb/libleveldb.a; cd /root/a-p-c/src/leveldb ; $(MAKE) clean
	-$(DEL_FILE) *~ core *.core
...
/root/a-p-c/src/leveldb/libleveldb.a: FORCE
	cd /root/a-p-c/src/leveldb && CC=gcc CXX=g++ $(MAKE) OPT="-m64 -pipe -fstack-protector-all -U_FORTIFY_SOURCE -D_FORTIFY_SOURCE=2 -O2" libleveldb.a libmemenv.a

/root/a-p-c/build/build.h: FORCE
	cd /root/a-p-c; /bin/sh share/genbuild.sh /root/a-p-c/build/build.h
